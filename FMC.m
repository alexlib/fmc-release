...
spectralRPC = fftshift(...
    splitComplex(fftn(...
    FMI_WINDOW .* FMI_02, [fmi_height, fmi_width]) .* ...
    conj(fftn(FMI_WINDOW .* FMI_01, [fmi_height, fmi_width])))) .* ...
    FMI_SPECTRAL_FILTER;
...
[TH, S, TX, TY, RPC_PEAK_HEIGHT_RATIO, RPC_PEAK_HEIGHT, RPC_PEAK_DIAMETER] ...
    ...
    estimated_rotation_initial, estimated_scaling_initial,...
    (YREGION - 1) - yc, (XREGION - 1) - xc, ...
    multi_peak_flag, DIFFERENCEMETHOD, COMPILED);
